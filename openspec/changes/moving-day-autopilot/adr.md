...
## Decision
Use Vercel for the static operator UI and package the TypeScript Strands service for AWS AgentCore Runtime. Provider systems are deterministic stateful sandbox adapters.
