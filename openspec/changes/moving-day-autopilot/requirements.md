...
8. Expose a live operator UI with an end-to-end demo requiring no judge credentials.
...
- Public HTTPS demo before submission.
- Public MIT repository before submission.
- No secrets in client code or repository.
- Deterministic demo path under three minutes.
